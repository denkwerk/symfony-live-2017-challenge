    ...
    public function getDatesForWednesday()
    {
        return [
            [
                ...
                \DateTime::createFromFormat('Y-m-d H:i:s', '2017-04-19 00:00:00')
            ],
            [
                \DateTime::createFromFormat('Y-m-d H:i:s', '2017-02-16 15:44:08'),
                \DateTime::createFromFormat('Y-m-d H:i:s', '2017-02-15 00:00:00')
            ],
            [
                \DateTimeImmutable::createFromFormat('Y-m-d H:i:s', '2017-12-24 02:00:00'),
                \DateTime::createFromFormat('Y-m-d H:i:s', '2017-12-20 00:00:00')
            ]
        ];
    }
}
